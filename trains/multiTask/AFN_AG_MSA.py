...
class AFN_AG_MSA():
    def __init__(self, args):
        ...
        self.loss_csv_file = '/home/liuweilong/DRAW/csv/adafnloss.csv'
        with open(self.loss_csv_file, mode='w', newline='') as file:
    ...
    def do_train(self, model, dataloader, return_epoch_results=False):
        ...
        while True: 
            ...
            with open(self.loss_csv_file, mode='a', newline='') as file:
                writer = csv.writer(file)
                writer.writerow([epochs, train_loss])            
            # logger.info(
    ...
    def do_test(self, model, dataloader, mode="VAL", return_sample_results=False):
        ...
        true_numpy = true.numpy()
        df = pd.DataFrame({
           'Predicted': pred_numpy.flatten(),
           'True': true_numpy
        })
        df.to_csv('/home/liuweilong/MMSA_AFN_AG_MSA/noadafn.csv', index=False)
        # case study
