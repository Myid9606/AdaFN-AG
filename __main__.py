...
def parse_args():
    ...
    parser.add_argument('-m', '--model', type=str, default='afn_ag_msa', help='Name of model',
                        choices=['lf_dnn', 'ef_lstm', 'tfn', 'lmf', 'mfn', 'graph_mfn', 'mult', 'bert_mag','tfnn', ############
                                 'misa', 'mfm', 'mlf_dnn', 'mtfn', 'mlmf', 'afn_ag_msa', 'mmim'])
    parser.add_argument('-d', '--dataset', type=str, default='mosi',
                        choices=['sims', 'mosi','msen', 'allmsen','mosei','sims3'], help='Name of dataset')
    parser.add_argument('-c', '--config', type=str, default='src/MMSA/config/config_regression.json',
    ...
    parser.add_argument('-s', '--seeds', action='append', type=int, default=[1111],
